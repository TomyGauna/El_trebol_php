    ...
    <header class="d-flex flex-wrap align-items-center justify-content-between py-3 mb-4 border-bottom">
        ...
        <div id="botones" class="text-end">
            <ul id="sueltos" class="nav nav-pills">
                <li class="nav-item"><a href="{{ route('home') }}" class="nav-link" aria-current="page">Inicio</a>
                </li>
                <!--<li class="nav-item">-->
                <!--    <div class="dropdown">-->
            ...
            <div class="nota_fuerte">
                <div class="card border-0">
                    <div class="d-flex justify-content-betwee">
                        <a class="text-dark" href="{{ route('news_in_segment', ['segment' =>  $note['segment']]) }}"><?php echo $note['segment']; ?></a>
                        <p class="w-100"><?php echo $note['dia_creacion']; ?></p>
                    </div>
                    <h1><?php echo $note['title']; ?> <?php echo $note['content']; ?></h1>
                    <h2 class="card-title"><?php echo $note['subtitle']; ?></h2>
                    <?php if ($note['image']): ?>
                        <img src="{{ asset('storage/' . $note['image']) }}" class="card-img-top img-principal" alt="<?php echo $note['title']; ?>">
                    <?php endif; ?>
                    

                    <?php if ($note['content_2']): ?>
                        <p><?php echo $note['content_2']; ?></p>
                    <?php endif; ?>

                    <?php if ($note['image_2']): ?>
                        <img src="{{ asset('storage/' . $note['image_2']) }}" class="card-img-top img-principal" alt="<?php echo $note['title']; ?>">
                    <?php endif; ?>

                    <?php if ($note['video_1']): ?>
                        <div class="yt">
                            <iframe src="<?php echo $note['video_1']; ?>" title="YouTube video player" frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                allowfullscreen></iframe>
                        </div>
                    <?php endif; ?>

                    <?php if ($note['content_3']): ?>
                        <p><?php echo $note['content_3']; ?></p>
                    <?php endif; ?>

                    <?php if ($note['image_3']): ?>
                        <img src="{{ asset('storage/' . $note['image_3']) }}" class="card-img-top" alt="...">
                    <?php endif; ?>

                    <?php if ($note['video_2']): ?>
                        <div class="yt">
                            <iframe src="<?php echo $note['video_2']; ?>" title="YouTube video player" frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                allowfullscreen></iframe>
                        </div>
                    <?php endif; ?>

                    <?php if ($note['content_4']): ?>
                        <p><?php echo $note['content_4']; ?></p>
                    <?php endif; ?>
