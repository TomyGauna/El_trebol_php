<!--Querido programador cuando escribi este codigo solo dios y yo sabiamos como funcionaba-->
<!--ahora solo dios sabe como funciona-->
<!--asi que si estas tratando de optimizar este codigo y fracasas (seguramente) subi en uno el contador de abajo para advertirle al siguiente colega-->
<!--programdores 1-->
<!DOCTYPE html>
<html lang="es">
        ...
        <div class="in_container">
            ...
            <div class="portada">
                ...
                <div class="nota_principal">
                    @foreach ($notes as $note)
                        @if ($note->is_field == 1)
                            <a href="{{ route('show_note', $note->id) }}">
                                <div class="card text-bg-dark">
                                    <img src="{{ asset('storage/' . $note['image']) }}" class="card-img" alt="{{ $note->title }}">
                                    <div class="card-img-overlay">
                                        <div>
                                            <h1><span>{{ $note->title }}</span> {{ $note->content }} </h1>
                                        </div>
                                    </div>
                                </div>
                            </a>
            ...
            <div id="segmento" class="hero">
                ...
                <div class="principal">
                    <div class="nota_fuerte">
                        @if ($newsMain)
                        <a href="{{ route('show_note', $newsMain->id) }}">
                            <div class="card border-0">
                                <img src="{{ asset('storage/' . $newsMain['image']) }}" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h3 class="card-title">
                                        <span>{{ $newsMain->title }}</span>
                                        {{ $newsMain->content }}
                                    </h3>
                                </div>
                            </div>
                ...
                <div id="cuatro_notas">
                    @foreach ($newsSec as $note)
                        @if ($note)
                        <a href="{{ route('show_note', $note->id) }}">
                            <div class="card border-0">
                                <img src="{{ asset('storage/' . $note['image']) }}" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title">{{ $note->title }}</h5>
                                    <p class="card-text">{{ $note->content }}</p>
                                </div>
