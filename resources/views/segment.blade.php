...
<head>
    ...
    <link rel="shortcut icon" href="../../../static/diario_app/svg/logo.svg" />
        ...
        <div class="in_container">
            ...
            <div class="portada">
                <div class="nota_principal">
                    <a href="{{ route('show_note', $newsMain->id) }}">
                        <div class="card text-bg-dark">
                            <img src="{{ asset('storage/' . $newsMain['image']) }}" class="card-img" alt="{{ $newsMain->title }}">
                            <div class="card-img-overlay">
                                <div>
                                    <h1><span>{{ $newsMain->title }}</span> {{ $newsMain->content }}</h1>
                                </div>
                            </div>
                        </div>
                    </a>
                ...
                <div class="notas_secundarias">
                    @foreach ($newsSec as $newsItem)
                        <a href="{{ route('show_note', $newsItem->id) }}">
            ...
            <div id="seg_notas" class="hero">
                @foreach ($otherNews as $other)
                    <div class="nota_fuerte">
                        <a href="{{ route('show_note', $other->id) }}">
                            <div class="card border-1 border-top-0 border-end-0 border-start-0">
                                <img src="{{ asset('storage/' . $other['image']) }}" class="card-img-top" alt="{{ $other->title }}">
                                <div class="card-body">
